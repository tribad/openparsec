...
ShipObject *proplist_ShipObject;

PRIVATE
proplist_s Ship1_PropList[] = {

	{ "damage",			&proplist_ShipObject->CurDamage,         	1,	500,		PROPTYPE_INT	},
	{ "maxdamage",      &proplist_ShipObject->MaxDamage,         	1,	500,		PROPTYPE_INT	},
	{ "energy",         &proplist_ShipObject->CurEnergy,            	1,	10000,		PROPTYPE_INT	},
	{ "maxenergy",      &proplist_ShipObject->MaxEnergy,         	1,	10000,		PROPTYPE_INT	},
	{ "speed",			&proplist_ShipObject->CurSpeed,          	1,	100000,		PROPTYPE_INT	},
	{ "maxspeed",       &proplist_ShipObject->MaxSpeed,          	1,	100000,		PROPTYPE_INT	},
	{ "weapons",        &proplist_ShipObject->Weapons,           	0,	0x70007,	PROPTYPE_INT	},
	{ "specials",		&proplist_ShipObject->Specials,				0,	0xfffff,	PROPTYPE_INT	},
	{ "dumb",           &proplist_ShipObject->NumMissls,         	0,	99,			PROPTYPE_INT	},
	{ "maxdumb",        &proplist_ShipObject->MaxNumMissls,      	0,	99,			PROPTYPE_INT	},
	{ "guide",          &proplist_ShipObject->NumHomMissls,      	0,	99,			PROPTYPE_INT	},
	{ "maxguide",       &proplist_ShipObject->MaxNumHomMissls,		0,	99,			PROPTYPE_INT	},
	{ "swarm",          &proplist_ShipObject->NumPartMissls,      	0,	99,			PROPTYPE_INT	},
	{ "maxswarm",       &proplist_ShipObject->MaxNumPartMissls,		0,	99,			PROPTYPE_INT	},
	{ "mines",          &proplist_ShipObject->NumMines,          	0,	99,			PROPTYPE_INT	},
	{ "maxmines",       &proplist_ShipObject->MaxNumMines,			0,	99,			PROPTYPE_INT	},
	{ "yawperref",		&proplist_ShipObject->YawPerRefFrame,		0,	100,		PROPTYPE_INT	},
	{ "pitchperref",	&proplist_ShipObject->PitchPerRefFrame,		0,	100,		PROPTYPE_INT	},
	{ "rollperref",		&proplist_ShipObject->RollPerRefFrame,		0,	100,		PROPTYPE_INT	},
	{ "xslideperref",	&proplist_ShipObject->XSlidePerRefFrame,		0,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "yslideperref",	&proplist_ShipObject->YSlidePerRefFrame,		0,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "speedincperref",	&proplist_ShipObject->SpeedIncPerRefFrame,	0,	0xffff,		PROPTYPE_INT	},
	{ "speeddecperref",	&proplist_ShipObject->SpeedDecPerRefFrame,	0,	0xffff,		PROPTYPE_INT	},
	{ "firerepdelay",	&proplist_ShipObject->FireRepeatDelay,		0,	500,		PROPTYPE_INT	},
	{ "firedisdelay",	&proplist_ShipObject->FireDisableDelay,		0,	500,		PROPTYPE_INT	},
	{ "missdisdelay",	&proplist_ShipObject->MissileDisableDelay,	0,	500,		PROPTYPE_INT	},
	{ "laser1.x1",      &proplist_ShipObject->Laser1_X[0][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.x2",      &proplist_ShipObject->Laser1_X[0][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.x3",      &proplist_ShipObject->Laser1_X[0][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.x4",      &proplist_ShipObject->Laser1_X[0][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.y1",      &proplist_ShipObject->Laser1_Y[0][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.y2",      &proplist_ShipObject->Laser1_Y[0][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.y3",      &proplist_ShipObject->Laser1_Y[0][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.y4",      &proplist_ShipObject->Laser1_Y[0][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.z1",      &proplist_ShipObject->Laser1_Z[0][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.z2",      &proplist_ShipObject->Laser1_Z[0][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.z3",      &proplist_ShipObject->Laser1_Z[0][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser1.z4",      &proplist_ShipObject->Laser1_Z[0][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.x1",      &proplist_ShipObject->Laser1_X[1][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.x2",      &proplist_ShipObject->Laser1_X[1][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.x3",      &proplist_ShipObject->Laser1_X[1][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.x4",      &proplist_ShipObject->Laser1_X[1][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.y1",      &proplist_ShipObject->Laser1_Y[1][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.y2",      &proplist_ShipObject->Laser1_Y[1][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.y3",      &proplist_ShipObject->Laser1_Y[1][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.y4",      &proplist_ShipObject->Laser1_Y[1][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.z1",      &proplist_ShipObject->Laser1_Z[1][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.z2",      &proplist_ShipObject->Laser1_Z[1][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.z3",      &proplist_ShipObject->Laser1_Z[1][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser2.z4",      &proplist_ShipObject->Laser1_Z[1][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.x1",      &proplist_ShipObject->Laser1_X[2][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.x2",      &proplist_ShipObject->Laser1_X[2][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.x3",      &proplist_ShipObject->Laser1_X[2][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.x4",      &proplist_ShipObject->Laser1_X[2][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.y1",      &proplist_ShipObject->Laser1_Y[2][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.y2",      &proplist_ShipObject->Laser1_Y[2][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.y3",      &proplist_ShipObject->Laser1_Y[2][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.y4",      &proplist_ShipObject->Laser1_Y[2][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.z1",      &proplist_ShipObject->Laser1_Z[2][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.z2",      &proplist_ShipObject->Laser1_Z[2][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.z3",      &proplist_ShipObject->Laser1_Z[2][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser3.z4",      &proplist_ShipObject->Laser1_Z[2][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	/* Duplicates? { "laser3.x1",      Ship1Obj_Laser3X1, -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	...
	*/
	{ "laser4.x1",      &proplist_ShipObject->Laser1_X[3][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.x2",      &proplist_ShipObject->Laser1_X[3][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.x3",      &proplist_ShipObject->Laser1_X[3][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.x4",      &proplist_ShipObject->Laser1_X[3][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.y1",      &proplist_ShipObject->Laser1_Y[3][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.y2",      &proplist_ShipObject->Laser1_Y[3][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.y3",      &proplist_ShipObject->Laser1_Y[3][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.y4",      &proplist_ShipObject->Laser1_Y[3][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.z1",      &proplist_ShipObject->Laser1_Z[3][0], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.z2",      &proplist_ShipObject->Laser1_Z[3][1], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.z3",      &proplist_ShipObject->Laser1_Z[3][2], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "laser4.z4",      &proplist_ShipObject->Laser1_Z[3][3], -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "missile1.x1",    &proplist_ShipObject->Missile1_X[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.x2",    &proplist_ShipObject->Missile1_X[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.x3",    &proplist_ShipObject->Missile1_X[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.x4",    &proplist_ShipObject->Missile1_X[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.y1",    &proplist_ShipObject->Missile1_Y[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.y2",    &proplist_ShipObject->Missile1_Y[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.y3",    &proplist_ShipObject->Missile1_Y[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.y4",    &proplist_ShipObject->Missile1_Y[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.z1",    &proplist_ShipObject->Missile1_Z[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.z2",    &proplist_ShipObject->Missile1_Z[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.z3",    &proplist_ShipObject->Missile1_Z[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile1.z4",    &proplist_ShipObject->Missile1_Z[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.x1",    &proplist_ShipObject->Missile2_X[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.x2",    &proplist_ShipObject->Missile2_X[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.x3",    &proplist_ShipObject->Missile2_X[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.x4",    &proplist_ShipObject->Missile2_X[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.y1",    &proplist_ShipObject->Missile2_Y[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.y2",    &proplist_ShipObject->Missile2_Y[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.y3",    &proplist_ShipObject->Missile2_Y[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.y4",    &proplist_ShipObject->Missile2_Y[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.z1",    &proplist_ShipObject->Missile2_Z[0], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.z2",    &proplist_ShipObject->Missile2_Z[1], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.z3",    &proplist_ShipObject->Missile2_Z[2], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "missile2.z4",    &proplist_ShipObject->Missile2_Z[3], -0x7fffffff,	0x7fffffff,	PROPTYPE_GEOMV	},
	{ "mine1.x",		&proplist_ShipObject->Mine1_X,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "mine1.y",		&proplist_ShipObject->Mine1_Y,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "mine1.z",     	&proplist_ShipObject->Mine1_Z,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	/* unused { "beam.x1",        Ship1Obj_BeamX1,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	...
	*/
	{ "helix.x",		&proplist_ShipObject->Helix_X,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "helix.y",		&proplist_ShipObject->Helix_Y,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "helix.z",		&proplist_ShipObject->Helix_Z,  -0x7fffffff,	0x7fffffff,		PROPTYPE_GEOMV	},
	{ "helixspeed",		&proplist_ShipObject->HelixSpeed,		0,	0x1000000,		PROPTYPE_INT	},
	{ "helixlifetime",	&proplist_ShipObject->HelixLifeTime,		0,	0x1000000,		PROPTYPE_INT	},
    { "photonspeed",    &proplist_ShipObject->PhotonSpeed,       0,  0x1000000,      PROPTYPE_INT    },
    { "photonlifetime", &proplist_ShipObject->PhotonLifeTime,    0,  0x1000000,      PROPTYPE_INT    },
